    ...
    methods: {
      ...
      loadGoogleMap() {
        ...
        let mapLib = document.createElement("script")
		 mapLib.src = `https://maps.googleapis.com/maps/api/js?key=${ this.config.googleKey }&libraries=`;
        // mapLib.src = `https://maps.googleapis.com/maps/api/js?key=${ this.config.googleKey }&libraries=&v=weekly&language=vi`;
      ...
      initMap() {
        ...
        map = new google.maps.Map(document.getElementById("googleMap"), {
          zoom: 18,
          center: new google.maps.LatLng(this.centerPoints.lat, this.centerPoints.lng),
		...
		this.reverseGeocode(this.centerPoints)
	  ...
	  reverseGeocode(latLng) {
	                 ...
	                 geocoder.geocode({ location: latLng }, (results, status) => {
						  ...
						  this.$ownerInstance.callMethod('showLocation',results)
