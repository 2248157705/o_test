  ...
  <view class="u-skeleton">
    ...
    >
      ...
      >
        ...
        ></view>
        <template v-for="(item, index) in rowsArray" :key="index">
          <view
  ...
  methods: {
    setRowsArray() {
      ...
      for (let i = 0; i < this.rows; i++) {
        ...
        margin = this.rowsMargin ? this.rowsMargin : "5px";
        ...
        item.margin = uni.$u.addUnit(margin);
        rows.push(item);
      }
      this.rowsArray = rows;
    },
