<template>
  <view
    ...
    @tap="clickHandler"
  >
    <view class="u-text__prefix-image" v-if="prefixImage">
      <image :src="prefixImage" :style="prefixImageStyle"></image>
    </view>
    <text
    ...
    <view class="u-text__suffix-image" v-if="suffixImage">
      <image :src="suffixImage" :style="suffixImageStyle"></image>
    </view>
  </view>
</template>
