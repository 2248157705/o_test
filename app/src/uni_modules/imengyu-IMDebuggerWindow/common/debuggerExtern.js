...
function installConsoleHook() {
	...
	if (debuggerModule) {
		...
		console.log = function (...arg) {
			debuggerModule.addLog({ time: getNowTimeString(), type: 'log', objects: getResolve(arg) });
			console_log(...arg)
		}
		console.error = function (...arg) {
			debuggerModule.addLog({ time: getNowTimeString(), type: 'error', objects: getResolve(arg) });
			console_error(...arg)
		}
		console.info = function (...arg) {
			debuggerModule.addLog({ time: getNowTimeString(), type: 'info', objects: getResolve(arg) });
			console_info(...arg)
		}
		console.warn = function (...arg) {
			debuggerModule.addLog({ time: getNowTimeString(), type: 'warn', objects: getResolve(arg) });
			console_warn(...arg)
		}
	}
}
