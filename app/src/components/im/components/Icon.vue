...
// import { ref } from 'vue'
import iconBiaoqing from "@/static/images/im/my/icon-biaoqing.png";
import iconShipin2 from "@/static/images/im/my/icon-shipin2.png";
import iconTupian from "@/static/images/im/my/icon-tupian.png";
import iconPaishe from "@/static/images/im/my/icon-paishe.png";
import sendMore from "@/static/images/im/my/send-more.png";
