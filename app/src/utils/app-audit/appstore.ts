...
import { appsotreGreementMap } from "@/utils/platform-greement";

export const tabBarItems = [
  {
    pagePath: "pages/audit/appstore/home",
    text: "首页",
  ...
  {
    pagePath: "pages/audit/appstore/security-center",
    text: "安全中心",
  ...
  {
    pagePath: "pages/audit/appstore/order",
    text: "订单中心",
  ...
  {
    pagePath: "pages/audit/appstore/my",
    text: "我的",
...
export function Appstore_Audit() {
  const commonStore = useCommonStore();
  const userStore = useUserStore();
  commonStore.setPlatformGreement(appsotreGreementMap);
  setTabBarItems();
  uni.setTabBarStyle({
    midButton: {},
  });
